...
async def unified_execute_action(
    *,
    ...
    """Run the existing moderation action and return one common human-readable notification."""
    ...
    if action == "mute":
        # The base action has just created the newest active mute; retrieve its expiry from Telegram-side calculation.
        # Reconstruct the label from the configured token to keep the notification concise.
        from groupbot.routers.manual_moderation import _duration
